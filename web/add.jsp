      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
                <a href="#">
                <i class="fa fa-circle-o"></i><span>Editable</span> <!-- Aqui poner dependiendo el rol -->
                </a>
            </li>
            <!--<li>
                  ...
                  <div class="box-body">
                    ...
                    <!--<div class="form-group"> 
                         ...
                         <select name="empleado" class="form-control-static" >
                            ...
                            <option class="option-control" value="JefeProyecto"> Jefe de proyecto </option>
                            <option class="option-control" value="Analista"> Analista </option>
                            <option class="option-control" value="Disenador"> Diseñador </option>
                            <option class="option-control" value="AnalistaProgramador"> Analista-Programador </option>
                            <option class="option-control" value="ResponsablePruebas"> Responsable de equipo de pruebas </option>
                            <option class="option-control" value="Programador"> Programador </option>
